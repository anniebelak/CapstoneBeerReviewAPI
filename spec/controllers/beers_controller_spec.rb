...
RSpec.describe BeersController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new beer" do

        post :create, params: {beer: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(beer_url(Beer.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new beer" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the beer" do
        beer = Beer.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the beer" do
        beer = Beer.create! valid_attributes
